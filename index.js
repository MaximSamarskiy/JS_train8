...
function filterByCondition(arr, condition) {
  ...
  const filterFn = (arr, condition) => arr % 2 === 0;
...
function customEvery(arr, condition) {
  ...
  return arr.every((condition) => condition >= 0);
}
...
function customUnshift(arr, ...elements) {
  ...
  return { initialLength: `${initialLength}, newLength: ${er}, arr: [${arr}]` };
}
